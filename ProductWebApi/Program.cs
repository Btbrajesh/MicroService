...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "Product Microservice API", Version = "v1" });
...
//{
//    c.IncludeXmlComments(@"C:\Users\shrip\source\repos\Microservices\ProductWebApi\Product.Microservice.xml");
