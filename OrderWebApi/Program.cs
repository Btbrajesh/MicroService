...
{
    option.SwaggerDoc("v1", new OpenApiInfo { Title = "Order Microservice API", Version = "v1" });
...
//{
//    c.IncludeXmlComments(@"C:\Users\shrip\source\repos\Microservices\OrderWebApi\Order.Microservice.xml");
